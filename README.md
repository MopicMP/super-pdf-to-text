...
> Super extract text from pdf files

[![PyPI version](https://badge.fury.io/py/super-pdf-to-text.svg)](https://pypi.org/project/super-pdf-to-text/)
...
from super_pdf_to_text import batch
